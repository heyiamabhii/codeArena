       ...
       >
         ...
         >
           <div className="hidden md:block py-16 px-8 text-white xl:w-[40rem]">
             {/* <span className="rounded-full bg-[#100821] px-3 py-1 font-medium text-violet-400">codeArena</span> */}
             ...
             <p className="mb-4 text-black text-lg">
               codeArena is a free site where developers can work on coding and algorithms problems together with others.
             </p>
             <Link
