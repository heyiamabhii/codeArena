...
const AppContent = () => {
  ...
  const shouldHideNavbar = location.pathname === "/auth" || location.pathname.includes("codeArena");
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/problems/codeArena/:id" element={<Editor />} />
        <Route path="/codeArena/:codeArena/:id" element={<Editor />} />
