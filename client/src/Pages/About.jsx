export default function About() {
  return (
    <div className="mt-[18vh] flex justify-center items-center flex-col text-white">
      <p className="text-2xl font-bold">WHAT IS codeArena</p>
      <p className="w-[80vw] lg:max-w-[50vw] text-center mt-3">codeArena is a dynamic and interactive coding platform designed for competitive programming, enabling users to engage in real-time coding battles with others.</p>
      <p className="text-slate-400 my-4">(Here's the full tutorial of codeArena)</p>
